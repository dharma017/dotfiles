...
class Push_reminder extends CI_Controller
{
		...
		function parseNotify($list) {
				...
				$APPLICATION_ID =$this->config->item('83UvumCLXDMrfNYtxS78YKViHRsd8MZikaHkosAI');
				$REST_API_KEY =$this->config->item('i4ZfjpOHWQ6NHiWJqabyFQtRQ36T08Kako1NFYHO');
				$url = $this->config->item('https://parseapi.back4app.com/');
