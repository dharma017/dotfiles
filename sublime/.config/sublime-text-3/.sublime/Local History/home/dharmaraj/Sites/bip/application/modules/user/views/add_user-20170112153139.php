...
$sess_permission=json_decode(json_encode($sess_permission),true);
								...
								if($edit_psy_id == $psychologistid && $edit_psy_per){
									...
									foreach ($psy_grp_itself as $data) {
										...
										<tr>
											...
											<input name="group_id[]" type="hidden"  value='<?= $data->id ?>'>
											<td align="center">
									...
									foreach ($psy_grp as $data) {
										...
										<tr>
											...
											<td align="center">
												<label class="customCheckbox">
													<?php $groupCheckedState = $edit_psy_per['rights_per_group'][$data->id]['treat_patients']; ?>
													<?php if(($sess_permission['rights_per_group'][$data->id]['create_psychologists'] == 0 && $sess_permission['rights_per_group'][$data->id]['manage_users'] == 0 && $sess_permission['rights_per_group'][$data->id]['treat_patients'] == 0) && $created_by != $psychologistid){
														$disabled = 'disabled';
													}else{
														$disabled = '';
													}
																...
																<tr>
																	...
																	<td align="center">
																		<label class="customCheckbox">
																			...
																			<input name="treat_patients_<?= $i ?>" type="hidden"  value='0'>
																			<?php if(($permission['rights_per_group'][$data->id]['create_psychologists'] == 0 && $permission['rights_per_group'][$data->id]['manage_users'] == 0) && $created_by != $psychologistid){
																				$disabled = 'disabled';
																			}else{
																				$disabled = '';
																			}
...
//print_r($data);exit();
																	...
																	<tr>
																		...
																		<input name="difficulty_id[]" type="hidden"  value='<?= $data->id ?>'>
																		<td align="center">
																			<label class="customCheckbox">
