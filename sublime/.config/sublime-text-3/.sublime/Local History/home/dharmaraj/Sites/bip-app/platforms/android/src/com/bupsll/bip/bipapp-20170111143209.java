...
public class bipapp extends Application 
{
    ...
    public void onCreate() { 
        ...
        try {
          // Parse.initialize(this, "83UvumCLXDMrfNYtxS78YKViHRsd8MZikaHkosAI","5flFEgqlEoh95Dwcn7i8HLT7BOczD2B7mlTAhPZS");
          Parse.initialize(new Parse.Configuration.Builder(this)
          .applicationId("83UvumCLXDMrfNYtxS78YKViHRsd8MZikaHkosAI")
          .clientKey("5flFEgqlEoh95Dwcn7i8HLT7BOczD2B7mlTAhPZS")
         ...
         installation.put("GCMSenderId", "899120845451");
