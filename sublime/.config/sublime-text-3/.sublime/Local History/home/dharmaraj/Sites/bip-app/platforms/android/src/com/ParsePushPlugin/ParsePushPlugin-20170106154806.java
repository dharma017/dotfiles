...
public class ParsePushPlugin extends CordovaPlugin {
    ...
    private void registerDevice(final CallbackContext callbackContext, final JSONArray args) {
    	try {
            ...
            ParseInstallation.getCurrentInstallation().setObjectId(null); 
            ...
            callbackContext.error("JSONException: " + e.toString() + " Json");
        } catch(Exception e){
        	callbackContext.error(e.toString()+ " Exception");
        }
    }
