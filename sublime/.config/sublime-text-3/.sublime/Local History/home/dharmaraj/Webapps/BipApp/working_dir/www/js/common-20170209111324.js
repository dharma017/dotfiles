                   ...
                   checkAvailableModules();
                    ...
                    callWebServiceLive(webmethodname, json, function(response) {
                        if (response.status === "ok") {
                            ...
                            // reinitialize jstorage for device type and parse installation id
                            $.jStorage.set('DeviceType',dtype);
                            $.jStorage.set('DeviceID',deviceinstallationid);
                            console.log('reinitialize device type '+dtype+' and device id  '+ deviceinstallationid);
