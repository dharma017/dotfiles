...
// echo "strong password ".$strpw;exit;
?>
<div id="box1" class="box box-100">
<!-- box full-width -->
<div class="boxin">
<div class="header">
<h3><?php //echo $this->lang->line("add_new_user");   ?>Add New User</h3>
</div>
<ul class="addstage">
<form name="frmAddUser" id="frmAddUser" method="post">
<li style=" margin-top:15px;">
<label class="label"><strong>User Name</strong></label>
...
<label style="width:700px;margin-left:136px;font-size:10px;">A strong password needs to be at least 8 characters long and contain at least one letter, one number and one symbol (e.g. @, *, #, $, %, etc.)</label>
</li>
<li>
...
<label style="display:none;color:red;" id="error_email_user"><em>Invalid Email</em></label>
</li>
<li>
...
if ($create || ($logintype == "admin" && $usertype == "superadmin") || $rows->psychologist_id == $psychologistid || $rows->id==$psychologistid) { ?>
...
<li>
<label class="label"><strong>Contact Number</strong></label>
...
<label style="display:none;color:red;" id="error_contact_number"><em>Invalid Contact Number</em></label>
<br/><label style="margin-left:136px">(Nummerformat: 070-000000)</label>
</li>
...
<label class="label"><input type="radio" id="communication" name="communication" value="1" <?php echo ($rows->communication == "1") ? 'checked="checked"' : ''; ?>/>Off</label><label class="label" style="margin-left: 15px;">
...
<label class="label"><strong>SMS/Email Notification</strong></label>
<input type="radio" id="sms_notify" name="sms_notify" value="1" <?php echo ($rows->sms_notify == "1") ? 'checked="checked"' : ''; ?>/> Yes &nbsp;&nbsp;&nbsp;
<input type="radio" id="sms_notify" name="sms_notify" value="0" <?php echo ($rows->sms_notify != "1") ? 'checked="checked"' : ''; ?>/> No
</li>
<li id="container_notify">
<label class="label"><strong>Email Notification</strong></label>
<input type="radio" id="email_notify" name="email_notify" value="1" <?php echo ($rows->email_notify == "1") ? 'checked="checked"' : ''; ?>/> Yes &nbsp;&nbsp;&nbsp;
<input type="radio" id="email_notify" name="email_notify" value="0" <?php echo ($rows->email_notify != "1") ? 'checked="checked"' : ''; ?>/> No
</li>
...
<thead>
<tr>
<td style="vertical-align: middle; width: 380px"><strong>Group name</strong></td>
<td align="center" style="width: 92px">Treat patients</td>
<td align="center" style="width: 92px">Manage Users</td>
<td align="center" style="width: 92px">Create psychologists</td>
<td align="center" style="width: 92px">Manage Psychologists</td>
<td align="center" style="width: 92px">Extract data</td>
</tr>
</thead>
</table>
<div style="max-height: 400px; width:100%; float:left; overflow:  auto; overflow-x: hidden;">
<table class="table fullwidth fleft">
<tbody>
<?php
if($logintype == "admin" && $usertype == "superadmin"){
$i = 0;
foreach ($group as $data) {
?>
<tr>
<td style="width: 380px;"><?php echo $data->group_name; ?></td>
...
<input type='checkbox' name='treat_patients_<?= $i ?>' value='1' <?php echo ($permission['rights_per_group'][$data->id]['treat_patients'] == "1") ? 'checked="checked"' : ''; ?>>
<span></span>
</label>
</td>
<td align="center" style="width: 92px">
...
<input type='checkbox' name='manage_users_<?= $i ?>' value='1' <?php echo ($permission['rights_per_group'][$data->id]['manage_users'] == "1") ? 'checked="checked"' : ''; ?>>
<span></span>
</label>
</td>
<td align="center" style="width: 92px">
...
<input type='checkbox' name='create_psychologists_<?= $i ?>' value='1' <?php echo ($permission['rights_per_group'][$data->id]['create_psychologists'] == "1") ? 'checked="checked"' : ''; ?>>
<span></span>
</label>
</td>
<td align="center" style="width: 92px">
...
<input type='checkbox' name='manage_psychologists_<?= $i ?>' value='1' <?php echo ($permission['rights_per_group'][$data->id]['manage_psychologists'] == "1") ? 'checked="checked"' : ''; ?>>
<span></span>
</label>
</td>
<td align="center" style="width: 92px">
...
<input type='checkbox' name='extract_data_<?= $i ?>' value='1' <?php echo ($permission['rights_per_group'][$data->id]['extract_data'] == "1") ? 'checked="checked"' : ''; ?>>
<span></span>
</label>
</td>
</tr>
...
<label class="label"><strong>Group</strong></label>
<?php


?>
<?php if($logintype == "admin" && $usertype == "superadmin"){
foreach ($group as $data) {
$all_grp[] = $data->id;
}
$grpid = implode(',', $all_grp);
}else{
$grpidarr=[];
foreach ($sess_permission['rights_per_group'] as $key => $diff_data) {
...
?>
<select name="group" id="group" onchange="getSelectedGrpId('<?php echo $grpid ?>')">
<?php
if(($logintype == "admin" && $usertype == "superadmin") || $create ){
...
<option value='0'>Choose Psychologist</option>
</select>
</li>
<li id="container_difficulty">
<label class="label"><strong>Diagnosis </strong></label>
<?php
// if($logintype == "admin" && $usertype == "superadmin"){
...
{
$query              = $this->db->query('select difficulty from bip_difficulty where id IN ('.$select.')');
...
<thead>
<tr>
<td style="width: 528px;"><strong>Difficulty name</strong></td>
<td align="center" style="width: 130px;">Edit Difficulty</td>
<td align="center" style="width: 130px;">Give rights to edit difficulty</td>
</tr>
</thead>
</table>
<div style="max-height: 400px; width:100%; float:left; overflow:  auto; overflow-x: hidden;">
...
if($logintype == "admin" && $usertype == "superadmin"){
$i = 0;
foreach ($result_diff as $data) { ?>
<tr>
<td style="width: 528px;"><?php echo $data->difficulty; ?></td>
<input name="new_difficulty_id[]" type="hidden"  value='<?= $data->id ?>'>
<input name="edit_difficulty_<?= $i ?>" type="hidden"  value='0'>
<td align="center"style="width: 130px;">
<label class="customCheckbox">
<input type='checkbox' name='edit_difficulty_<?= $i ?>' value='1' <?php echo ($permission['rights_per_difficulty'][$data->id]['edit_difficulty'] == "1") ? 'checked="checked"' : ''; ?>>
<span></span>
</label>
</td>
<td align="center"style="width: 130px;">
...
<input type='checkbox' name ='give_rights_to_edit_difficulty_<?= $i ?>' value='1' <?php echo ($permission['rights_per_difficulty'][$data->id]['give_rights_to_edit_difficulty'] == "1") ? 'checked="checked"' : ''; ?>>
<span></span>
</label>
</td>
</tr>
...
<td align="center" style="width: 130px;">
<label class="customCheckbox">
<?php if(($sess_permission['rights_per_difficulty'][$data->id]['give_rights_to_edit_difficulty'] == 0 /*&& $created_by != $psychologistid*/) && $edit_psy_id != $psychologistid){
	$disabled = 'disabled';
}else{
	$disabled = '';
}
...
<?php }
?>
<input <?=$disabled; ?> type='checkbox' class="checkbox_checked" name='edit_difficulty_<?= $i ?>' value='1' <?php echo ($edit_psy_per['rights_per_difficulty'][$data->id]['edit_difficulty'] == "1") ? 'checked="checked"' : ''; ?>>
<span></span>
</label>
</td>
<td align="center" style="width: 130px;">
...
<?php if($sess_permission['rights_per_difficulty'][$data->id]['give_rights_to_edit_difficulty'] == 0 /*&& $created_by != $psychologistid*/){
	$disabled = 'disabled';
}else{
	$disabled = '';
}
...
<?php }
?>
<input <?=$disabled; ?> type='checkbox' class="checkbox_checked" name ='give_rights_to_edit_difficulty_<?= $i ?>' value='1' <?php echo ($edit_psy_per['rights_per_difficulty'][$data->id]['give_rights_to_edit_difficulty'] == "1") ? 'checked="checked"' : ''; ?>>
<span></span>
</label>
</td>
</tr>
...
<td align="center" style="width: 130px;">
<label class="customCheckbox">
	<?php if($permission['rights_per_difficulty'][$data->id]['give_rights_to_edit_difficulty'] == 0  /*&& $created_by != $psychologistid*/){
		$disabled = 'disabled';
	}else{
		$disabled = '';
	}
	?>
	<input <?=$disabled; ?> type='checkbox' class="checkbox_checked" name='edit_difficulty_<?= $i ?>' value='1'>
	<span></span>
</label>
</td>
<td align="center" style="width: 130px;">
<label class="customCheckbox">
	...
	?>
	<input <?=$disabled; ?> type='checkbox' class="checkbox_checked" name ='give_rights_to_edit_difficulty_<?= $i ?>' value='1'>
	<span></span>
</label>
</td>
</tr>
...
<input type='checkbox' id="createNewDifficulty" name ='create_new_difficulty' value='1' <?php echo ($permission['other_rights']['create_new_difficulty'] == "1") ? 'checked="checked"' : ''; ?>>
<span></span>
</label>
</td>
...
<input type='checkbox' id="createNewGroup" name ='create_new_group' value='1' <?php echo ($permission['other_rights']['create_new_group'] == "1") ? 'checked="checked"' : ''; ?>>
<span></span>
</label>
</td>
...
<?php if($sess_permission['other_rights']['create_new_difficulty'] == 0 /*&& $created_by != $psychologistid*/){
$disabled = 'disabled';
}else{
$disabled = '';
}
...
<input type='hidden' name='create_new_difficulty' value='0'>
<?php } ?>
<input <?=$disabled; ?> type='checkbox' class="checkbox_checked <?=$disabled; ?>" id="createNewDifficulty" name ='create_new_difficulty' value='1' <?php echo ($edit_psy_per['other_rights']['create_new_difficulty'] == "1") ? 'checked="checked"' : ''; ?>>
<?php }else{ ?>
<?php
$otherRightsCheckedState = $sess_permission['other_rights']['create_new_difficulty']; ?>
<input type='hidden' name='create_new_difficulty' value='0'>
<?php if($permission['other_rights']['create_new_difficulty'] == 0 /*&& $created_by != $psychologistid*/){
$disabled = 'disabled';
}else{
$disabled = '';
}
...
<input type='hidden' name='create_new_group' value='0'>
<?php if($sess_permission['other_rights']['create_new_group'] == 0 /*&& $created_by != $psychologistid*/){
$disabled = 'disabled';
}else{
$disabled = '';
}
...
<input type='hidden' name='create_new_group' value='0'>
<?php } ?>
<input <?=$disabled; ?> class=" checkbox_checked" type='checkbox' id="createNewGroup" name ='create_new_group' value='1' <?php echo ($edit_psy_per['other_rights']['create_new_group'] == "1") ? 'checked="checked"' : ''; ?>>
<?php }else{ ?>
<?php $otherRightsCheckedState = $sess_permission['other_rights']['create_new_group']; ?>
<input type='hidden' name='create_new_group' value='0'>
<?php if($permission['other_rights']['create_new_group'] == 0 /*&& $created_by != $psychologistid*/){
$disabled = 'disabled';
}else{
$disabled = '';
}
?>
<input <?=$disabled; ?> class="checkbox_checked" type='checkbox' id="createNewGroup" name ='create_new_group' value='1'>
<?php } ?>
<span></span>
</label>
</td>
...
<li>
<label class="label"><strong>Active From</strong></label>
<input type="text" id="from"  class="inputs"  name="from" value="<?php echo $rows->active_from; ?>"/>
<strong style=" padding: 0 5px;">Active to</strong>
<input type="text" id="to" name="to" class="inputs" value="<?php echo $rows->active_to; ?>" />
</li>
<li id="activate_app_li">
<label class="label"><strong>Activate App</strong></label>
<input type="radio" id="app_status" name="app_status" value="1" <?php echo ($rows->app_status == "1") ? 'checked="checked"' : ''; ?>/> Yes &nbsp;&nbsp;&nbsp;
<input type="radio" id="app_status" name="app_status" value="0" <?php echo ($rows->app_status != "1") ? 'checked="checked"' : ''; ?>/> No
</li>
<li id="activate_app_li" class="web-version">
...
<option  <?php if ($rows->status != "1" && isset($rows->status))
echo "selected"; ?> value="0">Deactive</option>
</select>
</li>
<?php echo validation_errors('<li class="txt-left error_msg">','</li>'); ?>
<li style="clear:left;  margin-top:15px;">
<input type="button" name="btnSave" id="btnSave" value="<?php echo $this->lang->line("save"); ?>"  onclick="addUser();" class="button" />
<input type="button" name="btnCancel" id="btnCancel" value="<?php echo $this->lang->line("cancel"); ?>" onclick="listUser('id asc','');" class="button" />
</li>
...
//"similar-to-username": "Too similar to username, Please use strong alphanumeric password.",
//"too-short": "Too short, Please use strong alphanumeric password",
//"very-weak": "Very weak, Please use strong alphanumeric password",
//"weak": "Weak, Please use strong alphanumeric password.",
//"good": "Good",
//"strong": "Strong"
//}
//$("#autogeneratedpw").keyup(function(){
